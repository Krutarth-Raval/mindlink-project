...
const MODELS = {
    ...
    video: {
        name: "Gen-4.5",
        provider: "RunwayML",
        engine: "Runway Gen-4.5 Ultra",
        tag: "Cinematic · 5 Credits",
        badge: "NEW",
        description: "State-of-the-art cinematic video generation using RunwayML Gen-4.5. Produces ultra-realistic 4K resolution short clips with high motion fidelity.",
        specs: [
            { label: "Output", value: "1280 × 720 · MP4" },
            { label: "Models", value: "Gen-4.5 / Veo-3.1" },
            { label: "Provider", value: "RunwayML" },
